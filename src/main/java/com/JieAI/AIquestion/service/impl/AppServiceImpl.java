...
import com.JieAI.AIquestion.mapper.AppMapper;
import com.JieAI.AIquestion.model.dto.app.AppQueryRequest;
import com.JieAI.AIquestion.model.entity.App;
import com.JieAI.AIquestion.model.entity.User;
import com.JieAI.AIquestion.model.entity.enums.AppScoreStrategyEnum;
import com.JieAI.AIquestion.model.entity.enums.AppTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appType), ErrorCode.PARAMS_ERROR, "应用类型不能为空");
            ...
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appTypeEnum), ErrorCode.PARAMS_ERROR, "非法应用类别");
            AppScoreStrategyEnum appScoreStrategyEnum = AppScoreStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appScoreStrategyEnum), ErrorCode.PARAMS_ERROR, "非法评分策略");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
