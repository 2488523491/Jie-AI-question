package com.JieAI.AIquestion.manager;
...
public class AiManager {
    ...
    public Flowable<ModelData> doStreamRequest(String systemMessage, String userMessage, Boolean stream, Float temperature) {
        ...
        ChatMessage userChatMessage = new ChatMessage(ChatMessageRole.USER.value(), userMessage);
        chatMessageList.add(userChatMessage);
        return doStreamRequest(chatMessageList, stream, temperature);
    }
     ...
     * @return
     */
    public Flowable<ModelData> doStreamRequest(List<ChatMessage> messages, Boolean stream, Float temperature) {
        // 构建请求
        ChatCompletionRequest chatCompletionRequest = ChatCompletionRequest.builder()
                .model(Constants.ModelChatGLM4)
                .stream(stream)
